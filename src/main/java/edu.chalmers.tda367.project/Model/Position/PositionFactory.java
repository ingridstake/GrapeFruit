...
public class PositionFactory {
    ...
    public static HashMap<IPosition, List<IPosition>> makePositions() {
        ...
        positionListHashMap.put(positions.get(5), Arrays.asList(positions.get(4), positions.get(6)) );
        positionListHashMap.put(positions.get(6), Arrays.asList(positions.get(5), positions.get(7)) );
