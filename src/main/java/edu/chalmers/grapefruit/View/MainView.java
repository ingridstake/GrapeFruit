...
public class MainView implements Observer {
     ...
     * @throws IOException
     */
    public void populateGameBoardView(List<ViewEntity> viewEntities, NodeClickHandler clickHandler, EventHandler diceHandler, EventHandler payToOpenBtnHandler) throws IOException {
        gameBoardView.populate(viewEntities, clickHandler, diceHandler, payToOpenBtnHandler);
    }
